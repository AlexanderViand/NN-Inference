...
def main():
    ...
    model.add(layers.Dense(units=30, use_bias=True, activation=internal_activation))
    add_activation_layer(model)

    # model.add(layers.Dense(units=784, use_bias=True, activation=internal_activation))
    # add_activation_layer(model)
    #
    # model.add(layers.Dense(units=16, use_bias=True, activation=internal_activation))
    # add_activation_layer(model)
